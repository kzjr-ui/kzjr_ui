<template>
  <label
    class="kzjr-radio-button"
    :class="[
      size ? 'kzjr-radio-button--' + size : '',
  ...
  >
    <input
      class="kzjr-radio-button__orig-radio"
      :value="label"
      type="radio"
      v-model="value"
      :name="name"
      ...
      @blur="focus = false"
    >
    <span class="kzjr-radio-button__inner" :style="value === label ? activeStyle : null">
      <slot></slot>
