(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("kzjr_ui/lib/utils/merge"), require("kzjr_ui/lib/button"), require("vue"), require("kzjr_ui/lib/utils/popup"), require("kzjr_ui/lib/input"), require("kzjr_ui/lib/utils/dom"), require("kzjr_ui/lib/utils/aria-dialog"), require("kzjr_ui/lib/utils/vdom"));
	else if(typeof define === 'function' && define.amd)
		define("message-box", ["kzjr_ui/lib/utils/merge", "kzjr_ui/lib/button", "vue", "kzjr_ui/lib/utils/popup", "kzjr_ui/lib/input", "kzjr_ui/lib/utils/dom", "kzjr_ui/lib/utils/aria-dialog", "kzjr_ui/lib/utils/vdom"], factory);
	else if(typeof exports === 'object')
		exports["message-box"] = factory(require("kzjr_ui/lib/utils/merge"), require("kzjr_ui/lib/button"), require("vue"), require("kzjr_ui/lib/utils/popup"), require("kzjr_ui/lib/input"), require("kzjr_ui/lib/utils/dom"), require("kzjr_ui/lib/utils/aria-dialog"), require("kzjr_ui/lib/utils/vdom"));
	else
		root["message-box"] = factory(root["kzjr_ui/lib/utils/merge"], root["kzjr_ui/lib/button"], root["vue"], root["kzjr_ui/lib/utils/popup"], root["kzjr_ui/lib/input"], root["kzjr_ui/lib/utils/dom"], root["kzjr_ui/lib/utils/aria-dialog"], root["kzjr_ui/lib/utils/vdom"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_30__, __WEBPACK_EXTERNAL_MODULE_31__, __WEBPACK_EXTERNAL_MODULE_32__, __WEBPACK_EXTERNAL_MODULE_33__, __WEBPACK_EXTERNAL_MODULE_35__) {
